          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div className="flex flex-col">
                <span className="font-display text-2xl font-bold">Ram Adventure</span>
                <span className="text-green-400 text-sm font-medium">Explore Kerala's Beauty</span>
              </div>
            </div>
            <p className="text-gray-300 mb-6 max-w-md leading-relaxed">
              Your trusted partner for exploring the magnificent beauty of Munnar and Kerala. 
              We create unforgettable memories with our premium travel experiences and 
          ...
          <div>
            ...
            <ul className="space-y-3">
              {services.map((service) => (
                <li key={service}>
                  <span className="text-gray-300 hover:text-green-400 transition-colors duration-200 cursor-pointer hover:translate-x-1 transform inline-block">
                    {service}
                  </span>
                </li>
              ))}
        ...
        <div className="border-t border-slate-700 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {currentYear} Ram Adventure. All rights reserved. | Crafted with ❤️ for Kerala Tourism
            </p>
